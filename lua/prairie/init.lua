...
local theme = lush(function(injected_functions)
	...
	local bg = hsl(40, 100, 94)
	local bg_visual = hsl(40, 100, 88)

	local fg = hsl(205, 100, 4)
	local fg_light = hsl(0, 0, 50)

	local blue = hsl(205, 100, 34)
	local green = hsl(109, 47, 29)
	...
	return {
		...
		-- Cursor({ fg = unset }), -- Character under the cursor
